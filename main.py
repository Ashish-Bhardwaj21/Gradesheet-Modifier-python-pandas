import pandas as pd
import math
df=pd.read_excel('C:/Users/ashish bhardwaj/PycharmProjects/gradesheet modifier/student.xlsx')
math=[]
sum_math=0
i=0
j=0
...
while ok:
   ...
   if q == 1:
      ...
      if t==1:
       ...
       exit()
    #Exit
writer = pd.ExcelWriter('C:/Users/ashish bhardwaj/PycharmProjects/gradesheet modifier/student.xlsx', engine='xlsxwriter')
